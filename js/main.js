...
https://www.youtube.com/watch?v=A45p48rDlwQ
*/
...
const getCleanState = () => // create a new state (this would be a constructor in a proper OOP language)
{
    return {
        ...
        numberOfMoves: 0,
        board: new Array(BOARD_SIZE).fill(_) // board state as a flat Array of 9 integers.. no need to complicate deep copy even further
    }
}
